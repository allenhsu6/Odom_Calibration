...
std::vector<geometry_msgs::PointStamped> mcu_path;  // 三维坐标点序列
...
/**
 * 得到时刻t时候 机器人在里程计坐标下的坐标, /odom和/base_link之间的tf变换
 * @param pose 机器人pose 三维向量x,y,theta 写入机器人当前相对于/odom的pose
 * @param t 当前时间
 * @return 是否正确处理
 * TODO: 这个函数中的tf变换，我还是没有看懂
 */
...
Scan2::Scan2()
{
    ...
    //进行里程计和激光雷达数据的同步
    // TODO: 看不懂  这部分应该是tf::MessageFilter这个函数吧
